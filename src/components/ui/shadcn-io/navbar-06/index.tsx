                ...
                <Sheet>
                  <SheetTrigger asChild>
                    <Button variant="ghost" size="icon" className="h-8 w-8">
                      ...
                      <span className="sr-only">Supported Tools</span>
                    </Button>
                  </SheetTrigger>
                  <SheetContent className="px-6">
                    <SheetHeader className="p-0 my-6">
                      <SheetTitle>Supported Tools</SheetTitle>
                      <SheetDescription>
                        MCP servers can be configured for the following tools
                      </SheetDescription>
                    </SheetHeader>
                    <div className="space-y-3">
                      {supportedTools.map((config) => (
                        <div
                          key={config.tool}
                          className="border-b pb-3 last:border-b-0 flex items-start justify-between gap-4"
                        >
